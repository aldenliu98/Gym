...
public class NewWorkoutListAdapter extends ArrayAdapter<Integer> {
    ...
    public NewWorkoutListAdapter(Context context, ArrayList<Integer> values) {
        super(context, R.layout.fragment_newworkout_scrollviewelement, values);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.fragment_newworkout_scrollviewelement, parent, false);
        }
        return convertView;
    }
}
